...
<form action="<?php echo ROOT; ?>/response" id="contactForm" method="post" class="form">
				...
				<span class="lbl">
					...
					<input type="text" title="Nome completo:" id="nome" name="nome"  class="inpt05 errorInpt" />
				...
				<span class="lbl">
					...
					<textarea class="inpt05tArea errorInpt" type="text" name="msg" id="msg" title="Mensagem" ></textarea>
